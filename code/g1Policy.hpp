...
class G1Policy: public CHeapObj<mtGC> {
 private:
  ...
  G1AdaptivePolicy* _adaptive_policy;
...
public:
  double mixed_gc_live_threshold() const;
  uint mixed_gc_count_target() const;  
  double old_cset_region_threshold() const;
  double heap_waste_percent() const;
